 ...
 */
 ...
 void loop() {
  digitalWrite(LED_BUILTIN, persistent_LED_state); //debugging - Bjorn
   if (Serial.available() > 0) {
     int inByte = Serial.read();
    
     persistent_LED_state = LOW; // debugging - Bjorn
